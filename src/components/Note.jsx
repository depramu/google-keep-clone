      ...
      {isEditing ? (
        <div className="note-edit">
          ...
          <div className="note-edit-actions">
            ...
            <button onClick={() => setIsEditing(false)} className="note-button note-button-cancel">Cancel</button>
          </div>
        </div>
      ) : (
        <div className="note-view" onClick={() => setIsEditing(true)}>
          ...
          <div className="note-actions">
            <button onClick={(e) => { e.stopPropagation(); handleDelete(); }} className="note-delete" title="Delete note">
